...
model = torch.load("mobilenet_shadow_tinyimage_overtrained.pth",map_location=torch.device('cpu'))#mobilenet_shadow_cifar_overtrained.pth
...
torch.save(model.state_dict(), 'mobilenet_shadow_tinyimage_overtrained.pth')
